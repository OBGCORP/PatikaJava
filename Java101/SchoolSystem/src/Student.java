public class Student {
    ...
    void addBulkExamNote(int mathNote, int mathVerbal, int bioNote, int bioVerbal, int phyNote, int phyVerbal) {
        ...
        if (bioNote >= 0 && bioNote <= 100) {
            this.chem.note = bioNote;
        }
        if (bioVerbal >= 0 && bioVerbal <= 100) {
            this.chem.verbal = bioVerbal;
        }
    ...
    void printNote() {
        ...
        System.out.println("Biology Grade: " + this.chem.note);
        System.out.println("Biology Verbal Grade: " + this.chem.verbal);
