    ...
    public void buyWeapon() {
        ...
        if (pickedWeapon != null) {
            ...
            if (pickedWeapon.getPrice() > this.getPlayer().getCharacter().getMoney()) {
                ...
                System.out.println("Previous weapon " + this.getPlayer().getCharacter().getInventory().getWeapon().getName() + ", changed with " + pickedWeapon.getName());
    ...
    public void buyArmor() {
        ...
        if (pickedArmor != null) {
            ...
            if (pickedArmor.getPrice() > this.getPlayer().getCharacter().getMoney()) {
                ...
                //PLAYER'S WEAPON INVENTORY CHANGED MESSAGE
                System.out.println("Previous armor " + this.getPlayer().getCharacter().getInventory().getArmor().getName() + ", changed with " + pickedArmor.getName());
